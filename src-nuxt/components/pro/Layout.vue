...
<template>
  <n-layout position="absolute">
    <!-- Header -->
    <n-layout-header class="flex flex-row items-center pl-10 pr-4 space-x-4" :style="`height: ${props.headerHeight}px;`" bordered>
      <!-- logo -->
